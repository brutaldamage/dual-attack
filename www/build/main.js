...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(viewCtrl, gameState) {
...
var MyApp = /** @class */ (function () {
    ...
    MyApp.prototype.initWebServer = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, WebServerPlugin.startServer()];
                    case 1:
                        _a.sent();
                        WebServerPlugin.addListener("httpRequestReceived", function (info) {
                            _this.handleOnRequest(info);
                        });
                        return [2 /*return*/];
                }
            });
